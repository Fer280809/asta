// lib/economy-config.js
// Configuración del sistema de economía - Asta Bot
...
console.log('✅ Configuración de economía cargada desde economy-config.js')

export default global.economy
