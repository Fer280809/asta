...
const multiplicadores = [
  { valor: 0, prob: 30, emoji: '💀' },   // Pierde todo
  { valor: 0.5, prob: 25, emoji: '😢' }, // Pierde la mitad
  { valor: 1, prob: 20, emoji: '😐' },   // Recupera
  { valor: 1.5, prob: 15, emoji: '🙂' }, // Gana 50%
  { valor: 2, prob: 7, emoji: '😃' },   // Duplica
  { valor: 3, prob: 2.5, emoji: '🤩' }, // Triplica
  { valor: 5, prob: 0.5, emoji: '🎰' }  // x5 Jackpot!
]
...
let handler = async (m, { conn, args }) => {
  ...
  let cooldown = checkCooldown(userId, 'Tatar', 5 * 60 * 1000) // 5 minutos
