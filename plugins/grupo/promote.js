...
ׅㅤ𓏸𓈒ㅤׄ *ʙᴏᴛ* :: ɴᴇᴄᴇsɪᴛᴏ sᴇʀ ᴀᴅᴍɪɴɪsᴛʀᴀᴅᴏʀ`
  ...
  if (users.length === 0) {
    return conn.sendMessage(m.chat, {
      text: `> . ﹡ ﹟ 👑 ׄ ⬭ *¡ᴀsᴄᴇɴᴅᴇʀ ᴀᴅᴍɪɴ!*

*ㅤꨶ〆⁾ ㅤׄㅤ⸼ㅤׄ *͜📋* ㅤ֢ㅤ⸱ㅤᯭִ*
ׅㅤ𓏸𓈒ㅤׄ *ᴜsᴏ* :: *.promote @usuario*
ׅㅤ𓏸𓈒ㅤׄ *ᴀʟɪᴀs* :: *.promover*

> ## \`ɴᴏᴛᴀ ⚔️\`
> ᴍᴇɴᴄɪᴏɴᴀ ᴀʟ ᴜsᴜᴀʀɪᴏ ǫᴜᴇ ᴅᴇsᴇᴀs ᴀsᴄᴇɴᴅᴇʀ`
    }, { quoted: m })
  }
  ...
  for (let user of users) {
    try {
      ...
      res.push(`✅ @${user.split('@')[0]} ᴀʜᴏʀᴀ ᴇs ᴀᴅᴍɪɴɪsᴛʀᴀᴅᴏʀ`)
    } catch (e) {
